/**
 * Images of Enemies, Innocents and Bonus.
 */
var image_base_random = ['url(./images/robertPistol.png)', 'url(./images/brandonPistol.png)', 'url(./images/saimonPistol.png)'];
var image_base_allies = ['url(./images/alexa.png)', 'url(./images/amai.png)', 'url(./images/yaz.png)'];
var image_base_bonus = ['url(./images/cheems.png)'];
 ...
 */
var seeImage1 = document.getElementById('1');
var seeImage2 = document.getElementById('2');
var seeImage3 = document.getElementById('3');
var seeImage4 = document.getElementById('4');
var seeImage5 = document.getElementById('5');
var seeImage6 = document.getElementById('6');
var seeImage7 = document.getElementById('7');
var seeImage8 = document.getElementById('8');
...
/**
 * Appearance of the Enemies, Innocents and Bonus.
 */
function imgRandom() {
  if (game === true) {
